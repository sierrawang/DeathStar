...
class PostStorageStorageServiceHandler : virtual public PostStorageStorageServiceIf {
 public:
  PostStorageStorageServiceHandler() {
...
int main(int argc, char **argv) {
  int port = 9090;
  ::std::shared_ptr<PostStorageStorageServiceHandler> handler(new PostStorageStorageServiceHandler());
  ::std::shared_ptr<TProcessor> processor(new PostStorageStorageServiceProcessor(handler));
