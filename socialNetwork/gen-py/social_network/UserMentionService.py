...
class ComposeUserMentions_args(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i364 in range(_size360):
                        ...
                        self.usernames.append(_elem365)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 3:
    ...
    def write(self, oprot):
        ...
        if self.carrier is not None:
            ...
            for kiter374, viter375 in self.carrier.items():
