...
def updateTimeline():
  ...
  post_id = 0
  user_id = 0
  timestamp = 0 # this seems questionable
  transport.open()
  client.send_WriteUserTimeline(req_id, post_id, user_id, timestamp, {})
  transport.close()
...
def readTimeline():
  ...
  stop = 1
  transport.open()
  res = client.ReadUserTimeline(req_id, user_id, start, stop, {})
  transport.close()
  print(res)
